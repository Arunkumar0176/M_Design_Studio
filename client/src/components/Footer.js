        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/m.designstudio_official2026?igsh=MWljaHZnOXhua3pxMw%3D%3D&utm_source=qr" className="text-gray-300 hover:text-accent transition-colors">
              ...
              <a href="https://www.linkedin.com/in/m-design-studios-corporate-events-exhibition-conference-fabrication-0a6355167?utm_source=share_via&utm_content=profile&utm_medium=member_ios" className="text-gray-300 hover:text-accent transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300">
              ...
              <div className="flex items-start space-x-2">
                ...
                <span className="text-sm">Branch office Gopalganj, <br/>Bihar - 841428</span>
              </div>
            </div>
          </div>
        </div>
